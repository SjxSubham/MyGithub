...
const ProfileInfo = ({userProfile}) => {
	...
	// 	followers: 100,
	// 	following: 200,
	// 	html_url: "https://github.com/sjxsubham",
	// 	location: "Somewhere, Earth",
	// 	name: "Subham Mondal",
	// 	public_gists: 100,
	// 	public_repos: 100,
	// 	twitter_username: "@SjxSubham4249",
    //     linkedin_username: "https://www.linkedin.com/in/subham-mondal-914b0b2b8",
	// 	login: "sjxsubham",
	// };
	const memberSince = formatMemeberSince(userProfile?.created_at);
	return (
		<div className='lg:w-1/3 w-full flex flex-col gap-2 lg:sticky md:top-10'>
			<div className='bg-glass rounded-lg p-4'>
				...
				{userProfile?.linkedin_username ? (
					<a
						href={`https://linkedin.com/${userProfile.linkedin_username}`}
						target='_blank'
						rel='noreferrer'
						className='flex items-center gap-2 hover:text-sky-500'
					>
				...
				{userProfile?.email && (
					<div className='my-2'>
						...
						<a  href={`mailto:${userProfile.email}.com`}
						target='_blank'
